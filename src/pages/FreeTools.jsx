      ...
      <section className="free-tools-hero" style={{ background: "var(--cream)", paddingTop: "120px", paddingBottom: "60px" }}>
        <div className="wrap">
          <div className="sh c">
            ...
            <h1 className="title" style={{ fontSize: "48px", marginTop: "12px" }}>Free tools for dog parents.</h1>
            <p className="lead mt12" style={{ maxWidth: "680px", margin: "16px auto 0" }}>
              Science-backed tools built for Indian dog parents. Know more, feed better — all completely free.
            </p>
          </div>
        </div>
      </section>

      <section style={{ background: "var(--cream)", paddingBottom: "80px" }}>
        <div className="wrap">
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: "14px" }} className="free-tools-grid">
            <ToolCard
              icon={
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--brown)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <ToolCard
              icon={
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--brown)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M12 2a3 3 0 0 0-3 3 3 3 0 0 0-3 3 3 3 0 0 0 .46 1.61A3 3 0 0 0 9 15h6a3 3 0 0 0 2.54-4.39A3 3 0 0 0 18 8a3 3 0 0 0-3-3 3 3 0 0 0-3-3z" />
...
function ToolCard({ icon, title, desc, onClick }) {
  return (
    <div
      ...
      onClick={onClick}
      onMouseEnter={(e) => {
        e.currentTarget.style.boxShadow = '0 8px 28px rgba(0,0,0,.07)';
        e.currentTarget.style.borderColor = 'rgba(0,0,0,.12)';
      }}
      onMouseLeave={(e) => {
        e.currentTarget.style.boxShadow = '';
        e.currentTarget.style.borderColor = 'rgba(0,0,0,.055)';
      }}
    >
      <div style={{
        width: "52px",
