...
export default function WhySection() {
    return (
        <section id="why">
            <div className="wrap">
                <div className="sh rv"><span className="lbl">Why Choose Us</span><h2 className="title">Not generic food.<br />Your dog's food.</h2><p className="lead mt12">A complete nutrition system powered by AI and guided by veterinary science.</p></div>
                <div className="fg sg">
                    <div className="fc"><div className="fi">🤖</div><div className="fc-t">AI-Driven Nutrition</div><div className="fc-d">India's first AI dog nutrition company builds a 100% personalised plan based on breed, age, weight and health goals.</div></div>
                    <div className="fc"><div className="fi">👨‍🍳</div><div className="fc-t">Bespoke Kitchens</div><div className="fc-d">Each batch freshly cooked daily in dedicated kitchens. Never mass-produced. Your dog's name is on the recipe.</div></div>
