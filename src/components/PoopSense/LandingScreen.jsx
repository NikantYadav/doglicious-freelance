...
import { ActivityIcon, FileIcon } from './Icons';

const CameraIconFeature = () => (
...
export const LandingScreen = ({ onGetStarted, onShowDisclaimer }) => {
  ...
  return (
    ...
    >
      <div style={{ width: '100%', maxWidth: 430, display: 'flex', flexDirection: 'column', minHeight: '100%' }}>
        ...
        {/* T&C */}
        <div style={{ padding: '12px 16px 0', background: '#F5EDE0', flexShrink: 0 }}>
          <div className="d-checkrow" onClick={() => setAgreed(v => !v)} style={{ alignItems: 'flex-start', gap: 10, padding: 0, margin: 0 }}>
