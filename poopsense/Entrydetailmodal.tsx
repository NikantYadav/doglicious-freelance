...
interface EntryDetailModalProps {
  ...
  onClose: () => void;
  onDownloadPDF: (entry: ScanEntry) => void;
}

export const EntryDetailModal: React.FC<EntryDetailModalProps> = ({ isOpen, entry, onClose, onDownloadPDF }) => {
        ...
        <div className="em-body">
          ...
          {entry.simpleEn && (
            <div style={{ background: 'linear-gradient(135deg,#E8F4FD,#D6EAF8)', border: '1px solid rgba(52,152,219,.25)', borderRadius: 10, padding: '10px 12px', margin: '10px 0', fontSize: 12, color: '#1A3550', lineHeight: 1.65 }}>
              ...
              <div style={{ marginTop: 8, paddingTop: 7, borderTop: '1px dashed rgba(52,152,219,.3)', fontSize: 10, color: '#2C3E50', lineHeight: 1.65 }}>
                <span style={{ color: 'var(--a)', fontWeight: 700 }}>🫀 Please note — </span>
                For informational purposes only. Please verify with your veterinarian.
              </div>
            </div>
          )}
