...
export const EditDogModal: React.FC<EditDogModalProps> = ({ isOpen, dog, onClose, onSave, onDelete, toast }) => {
      ...
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ background: 'var(--sf2)', borderRadius: 'var(--rs)', padding: 12, marginBottom: 12, border: '1px solid var(--bd)' }}>
          ...
          <div className="fg" style={{ marginBottom: 0 }}>
            <label className="fl">Parent Mobile <span className="req">*</span></label>
